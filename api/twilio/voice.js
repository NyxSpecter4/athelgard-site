// /api/twilio/voice — proxy to bountywarz.com ka-voice
...
module.exports = async function handler(req, res) {
  ...
  const url = UPSTREAM + '/api/ka-voice' + (req.url || '').replace('/api/twilio/voice', '');
  ...
  try {
    ...
    console.error('[voice] upstream fail:', e.message);
    res.statusCode = 200;
